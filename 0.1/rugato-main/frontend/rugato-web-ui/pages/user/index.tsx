...
export default function index() {
  ...
  const quickLinks = [
    { label: 'Menú', icon: RiDrinksLine, url: '/user/menu', color: Colors.green, desc: 'Historial de pedidos' },
    { label: 'Órdenes', icon: FiShoppingBag, url: '/user/orders', color: "orange.400", desc: 'Historial de pedidos' },
  ];
      ...
      <Layout>
        <User>
          <Nav
            ...
            subtitle="Bienvenido de nuevo al sistema"
          />
